...
type BlogPostByIdQuery = { readonly post: Maybe<(
    Pick<WpPost, 'id' | 'excerpt' | 'content' | 'title' | 'date'>
  ...
  )>, readonly previous: Maybe<Pick<WpPost, 'uri' | 'title'>>, readonly next: Maybe<Pick<WpPost, 'uri' | 'title'>> };
...
type WordPressPostArchiveQuery = { readonly allWpPost: { readonly nodes: ReadonlyArray<Pick<WpPost, 'excerpt' | 'uri' | 'date' | 'title'>> } };
...
type usersa12333GitgatsbyWordpresssrcpages404Js3159585216QueryVariables = Exact<{ [key: string]: never; }>;


type usersa12333GitgatsbyWordpresssrcpages404Js3159585216Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }> };

type LayoutQueryQueryVariables = Exact<{ [key: string]: never; }>;


type LayoutQueryQuery = { readonly wp: Maybe<{ readonly generalSettings: Maybe<Pick<WpGeneralSettings, 'title' | 'description'>> }> };

type BioQueryQueryVariables = Exact<{ [key: string]: never; }>;


type BioQueryQuery = { readonly author: Maybe<(
    Pick<WpUser, 'firstName' | 'description'>
    & { twitter: WpUser['name'] }
    & { readonly avatar: Maybe<Pick<WpAvatar, 'url'>> }
  )> };

type Unnamed_1_QueryVariables = Exact<{ [key: string]: never; }>;


type Unnamed_1_Query = { readonly wp: Maybe<{ readonly generalSettings: Maybe<Pick<WpGeneralSettings, 'title' | 'description'>> }>, readonly wpUser: Maybe<{ twitter: WpUser['name'] }> };
